...
class MessageTypeRegistryFactory implements MessageTypeRegistryFactoryInterface
{
    ...
    public function createStatusType(): MessageType
    {
        return new MessageType(
            ...
            'Generated when an aircraft\'s status changes according to the timeout values in the Data Settings menu'
        );
    }
    ...
    public function createClickType(): MessageType
    {
        return new MessageType(
            MessageType::CLK,
            'CLICK MESSAGE',
            'Generated when the user doubleclicks (or presses return) on an aircraft (i.e. to bring up the aircraft details window).'
        );
    }
